    ...
    render() {
        ...
        return (
            <div>
                ...
                <Draggable
                    {...dragHandlers}
                    scrollTimeoutValue={0.1}
                    scrollValue={1}
                    scrollDebounceValue={10}
                    scrollBottomThreshold={window.innerHeight - 200}
                    ...
                    >
                        <Draggable bounds="parent" {...dragHandlers}>
                            <div className="box">
                                ...
                                <br />
                                <br />
                                Both parent padding and child margin work
                                properly.
                            </div>
                        </Draggable>
                        <Draggable bounds="parent" {...dragHandlers}>
                ...
                <Draggable bounds="body" {...dragHandlers}>
                    <div className="box">
                        I can only be moved within the confines of the body
                        element.
                    </div>
                </Draggable>
                <Draggable {...dragHandlers}>
                ...
                <Draggable {...dragHandlers}>
                    <RemWrapper>
                        ...
                        >
                            ...
                            instead of{' '}
                            <span style={{ fontWeight: 700 }}>px</span> for my
                            transforms. I also have absolute positioning.
                            <br />
                            <br />I depend on a CSS hack to avoid double
                ...
                >
                    <div className="box">
                        My position can be changed programmatically. <br />I
                        have a drag handler to sync state.
                        <div>
                ...
                >
                    <div className="box">
                        My position can be changed programmatically. <br />I
                        have a dragStop handler to sync state.
                        <div>
                            <a href="#" onClick={this.adjustXPos}>
                                Adjust x ({controlledPosition.x})
                            </a>
